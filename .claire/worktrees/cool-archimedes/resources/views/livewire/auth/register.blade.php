<div class="min-h-[70vh] flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="mt-2 text-gray-500">Start shopping today</p>
        </div>
            ...
            <form wire:submit="register" class="space-y-5">
                <div>
                    ...
                    <input wire:model="name" type="text" autocomplete="name" placeholder="John Doe"
                           class="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 @error('name') border-red-400 @enderror">
                ...
                <div>
                    ...
                    <input wire:model="password_confirmation" type="password" autocomplete="new-password" placeholder="••••••••"
